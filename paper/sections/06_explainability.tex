...
embedding output, averaged across correctly-classified samples of
each family, 30 samples per family). Per-family top-$k$ overlaps
...
input-gradient saliency (30 correctly-classified samples per
family). Six of eight families have zero top-5 overlap, indicating
