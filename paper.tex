...
\author[1]{Arav Jain}
\author[1]{Divyanshu Bansal}
\author[1]{Harij Sharma}
\author[1]{Anshul Arora}
\affil[1]{Department of Applied Mathematics, Delhi Technological University, New Delhi, India\\
\texttt{\{aravjain\_mc22a13\_49, divyanshubansal\_mc22a14\_03, harijsharma\_mc22a14\_10, anshularora\}@dtu.ac.in}}
...
that attention reveals what the model relies on; \citet{wiegreffe2019attention} argue attention can still serve as
...
sandbox~\citep{droidmon}. Each trace is a sequence of Android API events
...
We compare against: Random Forest~\citep{breiman2001rf} (100 trees),
LinearSVM, Decision Tree, Gaussian Na\"{i}ve Bayes (GNB), and a 2-layer
BiLSTM~\citep{hochreiter1997lstm} ($d=128$, mean-pooled). All classical
