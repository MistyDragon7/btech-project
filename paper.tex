...
\author{
\IEEEauthorblockN{Arav Jain\textsuperscript{*}\thanks{*These authors contributed equally to this work.}}
\IEEEauthorblockA{\textit{Department of Applied Mathematics}\\
\textit{Delhi Technological University}\\
New Delhi, India\\
aravjain\_mc22a13\_49@dtu.ac.in}
\\[0.2cm]
\IEEEauthorblockN{Divyanshu Bansal\textsuperscript{*}}
\IEEEauthorblockA{\textit{Department of Applied Mathematics}\\
\textit{Delhi Technological University}\\
New Delhi, India\\
divyanshubansal\_mc22a14\_03@dtu.ac.in}
\and
\IEEEauthorblockN{Harij Sharma\textsuperscript{*}}
\IEEEauthorblockA{\textit{Department of Applied Mathematics}\\
\textit{Delhi Technological University}\\
New Delhi, India\\
harijsharma\_mc22a14\_10@dtu.ac.in}
\\[0.2cm]
\IEEEauthorblockN{Anshul Arora\textsuperscript{*}}
\IEEEauthorblockA{\textit{Department of Applied Mathematics}\\
\textit{Delhi Technological University}\\
New Delhi, India\\
...
Our approach builds a global multi-step API transition matrix,
...
with millions of new malicious samples detected annually~\cite{av_test_2023}.
...
Deletion tests~\cite{samek2017evaluating} provide an empirical criterion that sidesteps this debate: they measure directly
whether the tokens a model attends to are the tokens it relies on.
While gradient-based approaches~\cite{sundararajan2017integrated} or
attention rollout~\cite{abnar2020rollout} can yield more accurate saliency maps,
...
$L_{\max}=512$ using \textit{head truncation}, selected via a sweep over $\{256, 512, 768\}$ with both head
...
G.~D'Angelo, F.~Palmieri, and A.~Robustelli,
